...
to na koniec wzrosłoby to aż do
`r prettyNum(round(py$capital,2), big.mark = "&nbsp;", decimal.mark = ",", scientific = FALSE)`
zł, jest to wzrost na poziomie
...
do `r prettyNum(round(py$capital,2), big.mark = "&nbsp;", decimal.mark = ",", scientific = FALSE)`zł, mimo że
spółka ma tendencje wzrostowe.
